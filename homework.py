...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_run_1: int = 18
        coeff_run_2: int = 20
        calories: float = (coeff_run_1 * self.get_mean_speed() - coeff_run_2) * self.weight / self.M_IN_KM * (self.duration * self.M_IN_HOUR)
        return calories
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        calories = (self.coeff_walk_1 * self.weight + (self.get_mean_speed()**2 // self.height) * self.coeff_walk_2 * self.weight) * (self.duration * self.M_IN_HOUR)
        return calories
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        calories = (self.get_mean_speed() + self.coeff_swim_1) * self.coeff_swim_2 * self.weight
        return calories
